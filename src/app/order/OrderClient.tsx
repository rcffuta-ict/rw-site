...
export function OrderClient({ items }: { items: MerchItem[] }) {
    ...
    return (
        <section className={ui.card}>
            <div className={ui.cardTitle}>Order form</div>
            ...
            <div style={{ marginTop: 12, display: "grid", gap: 10 }}>
                <label>
                    <span className={ui.tag}>Name</span>
                    <input
                        value={customerName}
                ...
                <label>
                    <span className={ui.tag}>Phone</span>
                    <input
                        value={phone}
                ...
                <label>
                    <span className={ui.tag}>Email</span>
                    <input
                        value={email}
            ...
            <div style={{ marginTop: 16 }}>
                ...
                <div style={{ marginTop: 8, color: "var(--rw-muted)", fontSize: 13 }}>
                    Max 6MB. This is recorded now; Supabase Storage will store the file
                    later.
                </div>
            </div>
        </section>
