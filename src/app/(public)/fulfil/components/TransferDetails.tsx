                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="p-5 rounded-2xl bg-amber-50 border border-amber-200 sm:col-span-2 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-xs text-amber-700 mt-1 max-w-[35ch]">Please use this exact text in your transfer description/narration.</p>
                        </div>
                        <Button
                            variant="outlined"
                            onClick={() => navigator.clipboard.writeText(prescribedNarration)}
