...
function FulfilContent() {
    ...
    if (paymentStage === "done") {
        return (
            <div className="fixed inset-0 z-[100] bg-rw-surface-1 flex flex-col items-center justify-center p-6 text-center animate-fade-in">
                <div className="h-24 w-24 bg-green-100 text-green-600 rounded-[2.5rem] flex items-center justify-center mb-8 shadow-xl shadow-green-500/10">
                ...
                <p className="text-rw-muted font-medium text-lg max-w-[400px] mb-8">
                    Your receipt has been successfully uploaded and is now pending review.
                </p>
                
                <div className="flex flex-col items-center gap-4 mt-4">
                    <p className="text-sm font-bold text-rw-text-2 flex items-center gap-3 uppercase tracking-wider">
                        <span className="h-5 w-5 rounded-full border-2 border-rw-text-2 border-t-transparent animate-spin" />
                        Refreshing page...
                    </p>
                </div>
            </div>
    ...
    return (
        <div className="section-container py-8 lg:py-12 relative min-h-[85vh]">
            ...
            <div className="mt-16 text-center text-rw-muted text-sm font-medium border-t border-[var(--rw-border)] pt-8">
                <p className="mb-3">Need help or facing issues with your payment? Contact our support team via WhatsApp:</p>
