...
import { OrderSupportContact } from "@/components/common/SupportContact";
        ...
        <div className="rw-card p-8 sm:p-10 flex flex-col items-center text-center gap-5 border-t-[3px] border-t-[#FF6A00]">
            ...
            <div>
                ...
                <p className="text-rw-text-2 text-sm leading-relaxed max-w-sm mx-auto">
                    Your order{" "}
                    <span className="font-mono font-bold text-rw-ink">{orderRef}</span>{" "}
                    was found, but new payments aren&rsquo;t being accepted at the moment.
            ...
            <div className="my-16 border-t border-[var(--rw-border)] pt-12 space-y-10">
                ...
                <div>
                    ...
                    <div className="grid sm:grid-cols-3 gap-4">
                        {NEXT_STEPS.map((s) => (
                            <div key={s.n} className="rw-card p-5 flex flex-col gap-3">
                ...
                <OrderSupportContact
                    title="Have a question or your approval is delayed? Reach our team on WhatsApp."
                    center
                />
            </div>
        </div>
