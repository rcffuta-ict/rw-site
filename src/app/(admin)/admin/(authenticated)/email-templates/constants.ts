...
export const TEMPLATES: Template[] = [
  { key: "pending",          label: "Order Received",           category: "order",   icon: "📦" },
  { key: "partially_paid",   label: "Partial Payment",          category: "order",   icon: "💰" },
  { key: "paid",             label: "Fully Paid",               category: "order",   icon: "✅" },
  { key: "confirmed",        label: "Order Confirmed",          category: "order",   icon: "🔖" },
  { key: "in_production",    label: "In Production",            category: "order",   icon: "🛠" },
  { key: "delivered",        label: "Delivered",                category: "order",   icon: "🎉" },
  { key: "flagged",          label: "Order Flagged",            category: "order",   icon: "⚠️" },
  { key: "cancelled",        label: "Cancelled",                category: "order",   icon: "❌" },
  { key: "payment_pending",  label: "Receipt Received",         category: "payment", icon: "📄" },
  { key: "payment_approved", label: "Payment Approved",         category: "payment", icon: "✔️" },
  { key: "payment_flagged",  label: "Payment Flagged",          category: "payment", icon: "🚩" },
  { key: "payment_rejected", label: "Payment Rejected",         category: "payment", icon: "🚫" },
];
