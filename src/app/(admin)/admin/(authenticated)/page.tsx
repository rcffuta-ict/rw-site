        ...
        <div className="flex flex-col gap-8 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                <div>
                    ...
                    <p className="mt-1 text-sm text-rw-muted">
                        Redemption Week &apos;26 — RCF FUTA Admin
                    </p>
                </div>
            ...
            <div>
                <div className="flex items-center justify-between mb-5">
                    ...
                    <Link
                        href="/admin/orders"
                        className="text-sm text-rw-crimson hover:text-rw-crimson-dk font-medium transition-colors"
                    >
                        View all →
                    </Link>
                </div>
                    ...
                    <table className="w-full text-sm">
                        <thead>
                            <tr className="border-b border-[var(--rw-border)] bg-rw-bg-alt text-rw-muted">
                                ...
                                <th className="px-5 py-3.5 text-right font-semibold text-xs uppercase tracking-wider">
                                    Total
                                </th>
                                <th className="px-5 py-3.5 text-right font-semibold text-xs uppercase tracking-wider">
                                    Paid
            ...
            <div className="grid sm:grid-cols-3 gap-4">
                ...
                >
                    ...
                    <p className="text-sm text-rw-muted">
                        Bank details and payment config
                    </p>
                </Link>
            </div>
        </div>
