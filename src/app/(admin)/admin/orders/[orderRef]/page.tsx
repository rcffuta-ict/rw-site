            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 border-b border-[var(--rw-border)] pb-8">
                ...
                <div className="flex flex-col xs:flex-row gap-3 w-full sm:w-auto">
                    <Link 
                        ...
                        className="btn-secondary !h-12 px-6 text-[11px] font-bold uppercase tracking-widest flex items-center justify-center gap-2 w-full xs:w-auto"
                    >
                        <svg className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z" /></svg>
                        Full Info
                    </Link>
                    <button className="btn-secondary !h-12 px-6 text-[11px] font-bold uppercase tracking-widest w-full xs:w-auto">
                        Confirm
                    </button>
                    <button className="btn-primary !h-12 px-8 text-[11px] font-bold uppercase tracking-widest !bg-rw-ink hover:!bg-black shadow-lg w-full xs:w-auto">
                        Update
                    </button>
                </div>
            </div>
