...
const AIMS = [
    ...
    },
    {
        n: "02",
        title: "Alumni Legacy",
        desc: "Reconnecting generations. Preserving 38 years of fellowship heritage.",
    },
    {
        n: "03",
                ...
                <div className="grid lg:grid-cols-2 gap-16 xl:gap-24 items-start">
                    ...
                    <div>
                        ...
                        <p className="mt-5 text-rw-text-2 leading-relaxed text-lg max-w-[44ch]">
                            ...
                            lives since 1983. A spiritual home, a family, a legacy.
                        </p>

                        <div className="mt-10 grid grid-cols-2 gap-3">
                            <img
                                src={ph(340, 260, "Fellowship 1")}
                                alt="Fellowship moment"
                                className="rounded-2xl object-cover w-full h-48 hover-lift"
                            />
                            <img
                                src={ph(340, 260, "Fellowship 2")}
                                alt="Fellowship moment"
                                className="rounded-2xl object-cover w-full h-48 hover-lift mt-6"
                            />
                            <img
                                src={ph(700, 280, "Fellowship Wide")}
                                alt="Fellowship wide"
                                className="col-span-2 rounded-2xl object-cover w-full h-44 hover-lift"
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="flex flex-col">
                            {AIMS.map((a) => (
                                <li
                                    key={a.title}
                                    className="group flex gap-6 py-7 border-b border-[var(--rw-border)] last:border-0 hover:bg-rw-bg-alt -mx-4 px-4 rounded-xl transition-colors duration-200"
                                >
