...
export function HeroSection() {
    ...
    return (
        ...
        >
                ...
                <div className="max-w-3xl stagger-children">
                    ...
                    <div className="animate-fade-in-up mt-9 flex flex-wrap gap-2">
                        {[
                            ...
                            >
                                <svg
                                    className="h-3.5 w-3.5 text-[#FF0015] shrink-0"
                                    fill="none"
                                    stroke="currentColor"
                                    strokeWidth={2}
                                    viewBox="0 0 24 24"
            ...
            <div
                className="absolute right-0 top-0 bottom-0 w-[300px] xl:w-[340px] hidden lg:flex flex-col
