 ...
 * SponsorsSection. Config-driven, so new sponsors appear automatically.
 */
export function FeaturedSponsorsSection() {
    if (SPONSOR_LIST.length === 0) return null;
                    ...
                    {SPONSOR_LIST.map((sponsor) => (
                        ...
                        >
                            ...
                            <div className="relative z-10 flex flex-col h-full">
                                ...
                                <span className="inline-flex items-center gap-2 self-start rounded-xl bg-white px-5 py-2.5 text-sm font-bold transition-transform group-hover:translate-x-0.5"
                                    style={{ color: sponsor.blue }}
                                >
                                    Get free access
