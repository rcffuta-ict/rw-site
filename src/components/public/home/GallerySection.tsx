            ...
            <div className="section-container">
                <div className="mb-12 flex items-end justify-between gap-6">
                    <div>
                        ...
                        <h2 className="section-heading text-3xl sm:text-4xl">
                            Moments from Previous Redemption week
                        </h2>
                    </div>
                    <p className="text-sm text-rw-muted hidden sm:block max-w-[280px] text-right">
                        A visual journey through past editions, capturing the glory,
                        power, and beauty of our gathering.
                    </p>
                </div>
                ...
                <div className="grid grid-flow-dense grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 auto-rows-[200px]">
                    {[
                        ...
                        <div
                            key={i}
                            className={`${span} overflow-hidden rounded-2xl bg-rw-bg-alt hover-lift`}
                        >
                            <img
