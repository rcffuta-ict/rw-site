                ...
                <div className="section-container relative z-10 py-20 lg:py-28">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-10">
                        <div className="max-w-2xl">
                            ...
                            {/* Address pill */}
                            <div
                                className="mt-7 inline-flex items-center gap-3 bg-white/8 border border-white/15
                                            rounded-2xl px-5 py-3.5 backdrop-blur-sm"
                            >
                                <div
                                    className="shrink-0 h-8 w-8 rounded-xl bg-[#FF0015]/25 border border-[#FF0015]/30
            ...
            <div className="section-container section-py">
                <div className="grid lg:grid-cols-[1fr_420px] gap-10 xl:gap-16 items-start">
                    ...
                    <div>
                            ...
                            {HOW_TO_GET_THERE.map((d, i) => (
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-[#5c4048] mt-1.5 leading-relaxed">
                                            {d.desc}
                                        </p>
                                    </div>
                                </div>
                        ...
                        {/* Landmark callout */}
                        <div
                            className="mt-5 rounded-2xl bg-gradient-to-r from-[#FF0015]/5 to-[#FF6A00]/5
                    ...
                    <div className="lg:sticky lg:top-24">
                        {/* Map visual */}
                        <div
                            className="relative rounded-3xl overflow-hidden border border-[#e8d0d4] shadow-xl"
                        ...
                        >
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="relative">
                                    ...
                                    <div
                                        className="relative h-14 w-14 rounded-full bg-[#FF0015] flex items-center
                                    ...
                                    >
                                        ...
                                        <div
                                            className="absolute -bottom-1.5 left-1/2 -translate-x-1/2 h-3 w-3
                            ...
                            {/* Compass */}
                            <div
                                className="absolute top-4 right-4 h-9 w-9 rounded-full bg-white/90 border border-[#e8d0d4]
