...
const HOW_TO_GET_THERE = [
    {
        ...
        desc: "Take the Akure–Owo expressway toward FUTA. Enter via the Southgate junction and follow event signage. The auditorium is beside His Grace Pavilion.",
    },
    {
        icon: (
            <svg
        ...
        desc: "Board any bus or keke heading to FUTA Southgate. Ask to alight at the Southgate roundabout. Keke shuttles run frequently on event nights.",
    },
    {
        icon: (
            <svg
        ...
        title: "Parking",
        desc: "Free parking within the FUTA Southgate compound. Event marshals will guide you. We recommend arriving 30 minutes early on peak nights.",
    },
];
    ...
    return (
        ...
        >
            ...
            <div className="section-container py-20 lg:py-28 relative">
                ...
                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#FF0015]/5 rounded-full blur-[120px] pointer-events-none" />
                <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[#FF6A00]/5 rounded-full blur-[100px] pointer-events-none" />

                <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-12">
                    <div className="max-w-2xl">
                        <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#FF0015] mb-5">
                            Find the Venue
                        </p>
                        <h2
                            className="font-display font-extrabold text-[#1C0003] leading-[0.92] tracking-tight"
                        ...
                        <div className="mt-10 flex flex-wrap gap-3">
                            <Link
                                ...
                                className="inline-flex items-center gap-2.5 h-12 px-7 rounded-xl font-bold text-[15px]
                                           bg-[#FF0015] text-white hover:bg-[#cc0011]
                            ...
                            <Link
                                ...
                                className="inline-flex items-center gap-2 h-12 px-7 rounded-xl font-semibold text-[15px]
                                           ...
                                           hover:border-[#FF0015] hover:text-[#FF0015] hover:bg-[#FF0015]/5 transition-all"
                            >
                                Support the Event
                            </Link>
                        </div>
            ...
            {/* Divider */}
            <div className="h-px bg-[#e8d0d4] mx-auto w-[calc(100%-4rem)] max-w-7xl" />
