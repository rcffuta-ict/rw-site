...
export const seedProgramme: ProgrammeDay[] = [
    ...
    },
    {
        ...
        dayLabel: "Thursday",
        title: "Drama Night",
        description: "Drama, stories, and expression.",
    },
    {
        id: "fri",
        dayLabel: "Friday",
        title: "Choir Concert",
        description: "Worship, songs, and a concert atmosphere.",
    },
    {
        id: "sat",
        dayLabel: "Saturday",
        title: "Alumni Reunion",
        description: "Connection, community, and celebration.",
    },
    {
        id: "sun",
        dayLabel: "Sunday",
        title: "Handing Over Service",
        description: "Thanksgiving and transition service.",
    },
];
